...
public class Credito extends Pagamento implements CalculaPagamento {
    
    public Credito(GregorianCalendar checkInCLiente, GregorianCalendar checkOutCliente, Reserva reserva) {
    ...
    public double calcularValorTotal(GregorianCalendar checkInCliente, GregorianCalendar checkOutCliente, Reserva reserva){
        ...
        return valor + valor * 0.05; //Acrescimo de 5% para pagamento via Cartão de Crédito
    }
}
