...
public class Dinheiro extends Pagamento implements CalculaPagamento {
    
    public Dinheiro(GregorianCalendar checkInCLiente, GregorianCalendar checkOutCliente, Reserva reserva) {
    ...
    public void pagar(double valor){
        System.out.println("Pagamento de R$"+ valor+" em dinheiro realizado com sucesso.");
    }
    @Override
    ...
    public double calcularValorTotal(GregorianCalendar checkInCliente, GregorianCalendar checkOutCliente, Reserva reserva){
        ...
        return valor - valor * 0.05; //Desconto de 10% para pagamento via Dinheiro
    }
}
